...
import {mainnet, polygon, base, sepolia, baseSepolia} from '@reown/appkit/networks'
...
const themeState = ref({ themeMode: 'dark', themeVariables: {} })
...
<template>
  ...
  <!--  <div class="button-group">
    ...
    <!-- State Displays -->
    <div class="state-container hidden" style="display: none">
      <section>
        <h2>Account</h2>
